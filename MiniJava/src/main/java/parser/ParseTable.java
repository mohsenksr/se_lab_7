...
public class ParseTable {
    ...
    public ParseTable(String jsonTable) throws Exception {
        String jsonTableSubstring = this.getJsonTableSubstring(jsonTable);
        String[] Rows = jsonTableSubstring.split("\\],\\[");
...
//        return 0;
    ...
    private String getJsonTableSubstring(String jsonTable) {
        return jsonTable.substring(2, jsonTable.length() - 2);
    }
}
